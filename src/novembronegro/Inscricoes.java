...
public class Inscricoes extends javax.swing.JFrame {
    ...
    //Object
    Programa pagePro = new Programa();
    
    //Polimorfismo: herdei o mesmo método da classe Programa e sobrescrevi o método.
    //Sobrescrita de método 
    //ToString
    @Override
    public String toString(){
        return "Evento realizado durante 3 dias. Segue abaixo as suas inscrições:";
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Minhas Inscrições");
        ...
        jLabel2.setText("NOVEMBRO NEGRO E INDÍGENA");

        jLabel3.setFont(new java.awt.Font("Segoe UI Black", 1, 30)); // NOI18N
        jLabel3.setText("DIA 23 ");
        ...
        jLabel4.setText("DIA 24 ");

        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel5.setText("NOVEMBRO NEGRO E INDÍGENA");
        ...
        jLabel6.setText("NOVEMBRO NEGRO E INDÍGENA");

        jLabel7.setFont(new java.awt.Font("Segoe UI Black", 1, 30)); // NOI18N
        jLabel7.setText("DIA 25");
    ...
    private void jLabel11AncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_jLabel11AncestorAdded
         if(pagePro.getDia1()){
            jLabel11.setText("Inscrito!");
        }else{
            jLabel11.setText("Não inscrito!");
        }
    ...
    private void jLabel13AncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_jLabel13AncestorAdded
         if(pagePro.getDia2()){
            jLabel13.setText("Inscrito!");
        }else{
            jLabel13.setText("Não inscrito!");
        }
    ...
    private void jLabel15AncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_jLabel15AncestorAdded
         if(pagePro.getDia3()){
            jLabel15.setText("Inscrito!");
        }else{
            jLabel15.setText("Não inscrito!");
        }
